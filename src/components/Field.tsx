...
import { getField, updateField, loadAndAddFileToField } from "../store";
      ...
      <div>
        ...
        <div class="relative mb-1">
          ...
          <input
            ...
            onInput={(e) =>
              updateField(id, { imagesrc: e.currentTarget.value })
            }
          />
          ...
          >
            <Show
              when={!isUploading}
              fallback={<div role="status" class="dot-flashing mx-3"></div>}
            >
